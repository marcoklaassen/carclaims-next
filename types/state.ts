...
export interface GlobalFormState {
  ...
  otherDriverSurName?: string;
  otherDriverStreetName?: string;
  otherDriverHouseNumber?: string;
  ...
  otherDriverDamagedParts?: string[];
